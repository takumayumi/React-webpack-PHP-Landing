/**
 * Features.js
 * Displays a section with a title, description, grid of feature blocks, and a call-to-action button.
 *
 * Author: Yumi Takuma
 */
...
const Feature = () => (
  <div className="flex flex-col items-center gap-5 text-center [&_>_svg]:h-auto [&_>_svg]:max-h-10 [&_>_svg]:w-auto [&_>_svg]:max-w-10 [&_>_svg]:fill-blue">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
      {/* Font Awesome icon - License: https://fontawesome.com/license/free */}
...
const Features = () => {
  return (
    <div className="relative block w-full bg-dark-red text-yellow">
